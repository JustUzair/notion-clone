...
export const TrashBox = () => {
  ...
  const onRestore = (
    ...
    toast.promise(promise, {
      loading: "Restoring deleted notes...",
      success: "Note(s) restored successfully!",
  ...
  const onRemove = (documentId: Id<"documents">) => {
    ...
    toast.promise(promise, {
      ...
      success: "Note(s) Deleted successfully!",
    ...
    <div className="text-sm">
      <div className="flex items-center gap-x-1 p-2">
        ...
        <Input
          ...
          className="h-7 px-2 focus-visible:ring-trasparent bg-secondary"
